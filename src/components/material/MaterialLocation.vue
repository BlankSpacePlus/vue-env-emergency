<template>
  <section>
    ...
    <template>
      <el-table stripe ref="multipleTable" :data="searchMaterialLocationList" highlight-current-row v-loading="loading" tooltip-effect="dark" style="width: 100%;" @selection-change="handleSelectionChange">
